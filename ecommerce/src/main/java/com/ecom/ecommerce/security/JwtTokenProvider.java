...
public class JwtTokenProvider {
    ...
    public String generateToken(Authentication authentication, Long time) {
        ...
        return Jwts.builder().setId(Long.toString(time)).setSubject(Long.toString(userPrincipal.getId()))
    ...
    public Long[] getUserIdFromJWT(String token) {
        ...
        return new Long[] { Long.parseLong(claims.getSubject()), Long.parseLong(claims.getId()) };
    }
